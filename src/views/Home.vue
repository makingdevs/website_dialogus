    ...
    <section>
      <div class="container">
        <div class="row">
          ...
          <script type="text/javascript">window.onload = function() { Calendly.initBadgeWidget({ url: 'https://calendly.com/makingdevs/30min', text: 'Programe una reunión conmigo', color: '#006bff', textColor: '#ffffff', branding: true }); }</script>
